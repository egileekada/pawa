    ...
    return (
        <div className=' w-full bg-[#252626] border text-[13px] text-[#fff]  border-b-0 border-[#444] font-Inter-Medium ' >
            <div className=' w-full h-[62px] border-b border-[#444] flex justify-between px-6 items-center ' >
                <p className=' text-[15px] text-[#C0C0C0] ' >Create NairaPin</p>
                <button onClick={()=> props.close()} >
                    <img src={Close} alt="close" />
                </button>
            </div> 
            <div className=' w-full h-[62px] border-b outline-none border-[#444] flex px-6 justify-between items-center ' >
                <p className=' ' >Amount per PIN</p>
                <div className=' w-[200px] ' > 
                    <Input type="number" placeholder='Amount' fontSize="13px" height="45px" borderRadius="none" borderColor="#444" />
                </div>
            </div>
            <div className=' w-full h-[62px] border-b outline-none border-[#444] flex px-6 justify-between items-center ' >
                <p className=' ' >Number of PINs</p>
                <div className=' w-[200px] ' > 
                    <Input type="number" placeholder='Pin' fontSize="13px" height="45px" borderRadius="none" borderColor="#444" />
                </div>
            </div>
